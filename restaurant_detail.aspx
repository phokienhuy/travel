<%@ Page Title="" Language="C#" MasterPageFile="~/DetailMasterpage.master" AutoEventWireup="true" CodeFile="restaurant_detail.aspx.cs" Inherits="restaurant_detail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <asp:DataList ID="RestDetail" runat="server" DataKeyField="Rest_ID" 
                DataSourceID="SQLRestDetail">
                <ItemTemplate>
                    <div class="grid_9">
                        <div class="">
                          <h3><%# Eval("Name") %></h3>
      ...
      <div class="clear"></div>
        ...
        SelectCommand="SELECT * FROM [ThongTinNhaHang] WHERE ([Rest_ID] = @Rest_ID)">
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="0" Name="Rest_ID" 
