...
public partial class admin_newCuisine : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        ThongTinAmThuc cuisine = new ThongTinAmThuc
        {
            Title = title.Text,
            CoverPic = coverPath,
            Content = mieuta.Text,
        ...
        try
        {
            db.ThongTinAmThucs.InsertOnSubmit(cuisine);
            db.SubmitChanges();
            Server.Transfer("cuisine.aspx", true);
        }
        catch (Exception ex)
        {
