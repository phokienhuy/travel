<%@ Page Language="C#" AutoEventWireup="true" CodeFile="restaurant.aspx.cs" Inherits="admin_restaurant" %>
        ...
        <div class="shell">
            ...
            <div id="navigation">
                <ul>
                    ...
                    <li><a href="restaurant.aspx" class="active"><span>Nhà Hàng</span></a></li>
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-head">
                            <h2>
                                Danh Sách Nhà Hàng</h2>
                        </div>
                        <!-- End Box Head -->
                        <!-- Table -->
                        <div class="table">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                DataKeyNames="Rest_ID" DataSourceID="SqlDataSource1" BorderWidth="0px" CellPadding="0"
                                GridLines="Horizontal" Width="100%">
                                <Columns>
                                    <asp:BoundField DataField="Rest_ID" HeaderText="ID" InsertVisible="False" ReadOnly="True"
                                        SortExpression="Rest_ID" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TravelConnectionString %>"
                                SelectCommand="SELECT [Rest_ID], [Name], [Address], [Phone] FROM [ThongTinNhaHang]"
                                ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [ThongTinNhaHang] WHERE [Rest_ID] = @original_Rest_ID AND (([Name] = @original_Name) OR ([Name] IS NULL AND @original_Name IS NULL)) AND (([Address] = @original_Address) OR ([Address] IS NULL AND @original_Address IS NULL)) AND (([Phone] = @original_Phone) OR ([Phone] IS NULL AND @original_Phone IS NULL))"
                                InsertCommand="INSERT INTO [ThongTinNhaHang] ([Name], [Address], [Phone]) VALUES (@Name, @Address, @Phone)"
                                OldValuesParameterFormatString="original_{0}" 
                                UpdateCommand="UPDATE [ThongTinNhaHang] SET [Name] = @Name, [Address] = @Address, [Phone] = @Phone WHERE [Rest_ID] = @original_Rest_ID AND (([Name] = @original_Name) OR ([Name] IS NULL AND @original_Name IS NULL)) AND (([Address] = @original_Address) OR ([Address] IS NULL AND @original_Address IS NULL)) AND (([Phone] = @original_Phone) OR ([Phone] IS NULL AND @original_Phone IS NULL))">
                                <DeleteParameters>
                                    <asp:Parameter Name="original_Rest_ID" Type="Int32" />
                        ...
                        <div class="box-content">
                            <div class="buttons">
                                <asp:LinkButton ID="addButton" runat="server" Font-Underline="false" CssClass="button"
                                    OnClick="addButton_Click">Thêm Nhà Hàng</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
