<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cuisine.aspx.cs" Inherits="admin_cuisine" %>
        ...
        <div class="shell">
            ...
            <div id="navigation">
                <ul>
                    ...
                    <li><a href="cuisine.aspx" class="active"><span>Ẩm Thực</span></a></li>
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-head">
                            <h2>
                                Danh Sách Ẩm Thực</h2>
                        </div>
                        <!-- End Box Head -->
                        <!-- Table -->
                        <div class="table">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                DataKeyNames="AmThuc_ID" DataSourceID="SqlDataSource1" BorderWidth="0px" CellPadding="0"
                                GridLines="Horizontal" Width="100%">
                                <Columns>
                                    <asp:BoundField DataField="AmThuc_ID" HeaderText="ID" InsertVisible="False" ReadOnly="True"
                                        SortExpression="AmThuc_ID" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TravelConnectionString %>"
                                SelectCommand="SELECT [AmThuc_ID], [Title] FROM [ThongTinAmThuc]"
                                ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [ThongTinAmThuc] WHERE [AmThuc_ID] = @original_AmThuc_ID AND (([Title] = @original_Title) OR ([Title] IS NULL AND @original_Title IS NULL))"
                                InsertCommand="INSERT INTO [ThongTinAmThuc] ([Title]) VALUES (@Title)"
                                OldValuesParameterFormatString="original_{0}" 
                                
                                UpdateCommand="UPDATE [ThongTinAmThuc] SET [Title] = @Title WHERE [AmThuc_ID] = @original_AmThuc_ID AND (([Title] = @original_Title) OR ([Title] IS NULL AND @original_Title IS NULL))">
                                <DeleteParameters>
                                    <asp:Parameter Name="original_AmThuc_ID" Type="Int32" />
                        ...
                        <div class="box-content">
                            <div class="buttons">
                                <asp:LinkButton ID="addButton" runat="server" Font-Underline="false" CssClass="button"
                                    OnClick="addButton_Click">Thêm Ẩm thực</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
