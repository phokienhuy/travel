...
public partial class admin_newPlace : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        ThongTinDuLich place = new ThongTinDuLich
        {
            Name = name.Text,
        ...
        try
        {
            db.ThongTinDuLiches.InsertOnSubmit(place);
            db.SubmitChanges();
            Server.Transfer("place.aspx", true);
        }
        catch (Exception ex)
        {
