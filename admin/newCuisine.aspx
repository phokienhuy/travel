<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newCuisine.aspx.cs" Inherits="admin_newCuisine" %>
...
<body>
    ...
    <div id="container">
        <div class="shell">
            <div class="small-nav">
                <a href="product.html">Dashboard</a> <span>&gt;</span> Ẩm thực
            </div>
            <!-- End Small Nav -->
            <!-- Message OK -->
                ...
                <div id="content">
                    ...
                    <div class="box">
                        ...
                        <div class="buttons">
                            ...
                            <input type="button" class="button" value="Trở Về" onclick="window.location = 'cusine.aspx'" />
                        </div>
                        <!-- End Form Buttons -->
                        </form>
                    </div>
