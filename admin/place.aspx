                ...
                <div id="content">
                    ...
                    <div class="box">
                        ...
                        <div class="table">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TravelConnectionString %>"
                                ...
                                DeleteCommand="DELETE FROM [ThongTinDuLich] WHERE [Travel_ID] = @original_Travel_ID AND (([Name] = @original_Name) OR ([Name] IS NULL AND @original_Name IS NULL)) AND (([Address] = @original_Address) OR ([Address] IS NULL AND @original_Address IS NULL)) AND (([Phone] = @original_Phone) OR ([Phone] IS NULL AND @original_Phone IS NULL))" 
                                InsertCommand="INSERT INTO [ThongTinDuLich] ([Name], [Address], [Phone]) VALUES (@Name, @Address, @Phone)" 
                                OldValuesParameterFormatString="original_{0}" 
                                UpdateCommand="UPDATE [ThongTinDuLich] SET [Name] = @Name, [Address] = @Address, [Phone] = @Phone WHERE [Travel_ID] = @original_Travel_ID AND (([Name] = @original_Name) OR ([Name] IS NULL AND @original_Name IS NULL)) AND (([Address] = @original_Address) OR ([Address] IS NULL AND @original_Address IS NULL)) AND (([Phone] = @original_Phone) OR ([Phone] IS NULL AND @original_Phone IS NULL))">
                                <DeleteParameters>
                    ...
                    <div class="box">
                        ...
                        <div class="box-content">
                            <div class="buttons">
                                <asp:LinkButton ID="addButton" runat="server" Font-Underline="false" 
                                    CssClass="button" onclick="addButton_Click">Thêm Địa Điểm</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
