...
public partial class admin_newRestaurant : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        ThongTinNhaHang hotel = new ThongTinNhaHang
        {
            Name = name.Text,
        ...
        try
        {
            db.ThongTinNhaHangs.InsertOnSubmit(hotel);
            db.SubmitChanges();
            Server.Transfer("restaurant.aspx", true);
        }
        catch (Exception ex)
        {
