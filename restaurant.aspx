...
<asp:Content ID="Content2" ContentPlaceHolderID="menu" Runat="Server">
    <nav class="" >
						        <ul class="sf-menu">
									         ...
									         <li class="current"><a href="restaurant.aspx">Nhà Hàng</a></li>
...
<h3>Các nhà hàng mới</h3>
		    </div>
    <asp:DataList ID="DataList1" runat="server" DataKeyField="Restaurant_ID" 
        DataSourceID="RestaurantList">
        <ItemTemplate>
            <div class="blog">
                <time datetime="2013-01-01"><%# Eval("InsertDay") %><br><%# Eval("InsertMonth") %></time>
                <div class="extra_wrapper">
                <div class="text1 upp"><asp:Label ID="lblRestaurantlName" runat="server" Text='<%# Eval("Name") %>' /> </div>
                <div class="links">
            ...
            <asp:SqlDataSource ID="RestaurantList" runat="server" 
        ConnectionString="<%$ ConnectionStrings:TravelConnectionString %>" 
        SelectCommand="SELECT TOP 10 * FROM [ThongTinNhaHang]"></asp:SqlDataSource>
