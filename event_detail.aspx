<%@ Page Title="" Language="C#" MasterPageFile="~/DetailMasterpage.master" AutoEventWireup="true" CodeFile="event_detail.aspx.cs" Inherits="event_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="menu" Runat="Server">
                <nav class="" >
						        <ul class="sf-menu">
									         ...
									         <li class="current"><a href="events.aspx">Sự kiện</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <asp:DataList ID="EventDetail" runat="server" DataKeyField="Event_ID" 
                DataSourceID="SQLEventDetail">
                <ItemTemplate>
                    <div class="grid_9">
                        <div class="">
                          <h3><%# Eval("Name") %></h3>
      ...
      <div class="clear"></div>
        ...
        SelectCommand="SELECT * FROM [Event] WHERE ([Event_ID] = @Event_ID)">
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="0" Name="Event_ID" 
