<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="hotels.aspx.cs" Inherits="hotels" %>
...
<h3>Các khách sạn mới</h3>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="Hotel_ID" 
        DataSourceID="HotelList">
        <ItemTemplate>
            <div class="blog">
                <time datetime="2013-01-01"><%# Eval("InsertDay") %><br><%# Eval("InsertMonth") %></time>
                <div class="extra_wrapper">
                <div class="text1 upp"><asp:Label ID="lblHotellName" runat="server" Text='<%# Eval("Name") %>' /> </div>
                <div class="links">
                ...
                <div class="extra_wrapper">
                    ...
                    <br>
                    <a href="hotel_detail.aspx?hid=<%# Eval("Hotel_ID") %>" class="btn">Xem</a>
                </div>
            </div>
            <br>
            <br>
            ...
            <asp:SqlDataSource ID="HotelList" runat="server" 
        ConnectionString="<%$ ConnectionStrings:TravelConnectionString %>" 
        SelectCommand="SELECT TOP 10 * FROM [ThongTinKhachSan]"></asp:SqlDataSource>
